...
// hex_distance vit dans `position` (type transverse) : `world` en a aussi besoin
// pour le brouillard, et deux domaines ne se référencent jamais l'un l'autre.
pub use crate::position::hex_distance;
