...
pub fn propose(states: &mut GameState) -> Vec<GatherOptionView> {
...
pub fn select(resource: Resource, states: &mut GameState) -> (Vec<GatherOptionView>, Vec<Event>) {
